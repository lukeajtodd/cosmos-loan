...
import LukeajtoddLoanLukeajtoddLoanLoan from './lukeajtodd/loan/lukeajtodd.loan.loan';
export default {
    ...
    LukeajtoddLoanLukeajtoddLoanLoan: load(LukeajtoddLoanLukeajtoddLoanLoan, 'lukeajtodd.loan.loan'),
};
