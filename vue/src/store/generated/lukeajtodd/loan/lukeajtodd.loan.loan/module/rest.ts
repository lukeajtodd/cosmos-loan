...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @request GET:/lukeajtodd/loan/loan/loan
   */
  queryLoanAll = (
    query?: {
    ...
    this.request<LoanQueryAllLoanResponse, RpcStatus>({
      path: `/lukeajtodd/loan/loan/loan`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @request GET:/lukeajtodd/loan/loan/params
   */
  queryParams = (params: RequestParams = {}) =>
    this.request<LoanQueryParamsResponse, RpcStatus>({
      path: `/lukeajtodd/loan/loan/params`,
      method: "GET",
      format: "json",
      ...params,
    });
