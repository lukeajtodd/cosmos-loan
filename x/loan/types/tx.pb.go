...
func init() {
	proto.RegisterType((*MsgRequestLoan)(nil), "lukeajtodd.loan.loan.MsgRequestLoan")
	proto.RegisterType((*MsgRequestLoanResponse)(nil), "lukeajtodd.loan.loan.MsgRequestLoanResponse")
}
...
var fileDescriptor_b8f8f93b4237d328 = []byte{
	...
	0xd3, 0x2f, 0xa9, 0xd0, 0x2b, 0x28, 0xca, 0x2f, 0xc9, 0x17, 0x12, 0xc9, 0x29, 0xcd, 0x4e, 0x4d,
	0xcc, 0x2a, 0xc9, 0x4f, 0x49, 0xd1, 0x03, 0xc9, 0x80, 0x09, 0xa5, 0x09, 0x8c, 0x5c, 0x7c, 0xbe,
	...
	0x54, 0xa3, 0x0c, 0x2e, 0x66, 0xdf, 0xe2, 0x74, 0xa1, 0x44, 0x2e, 0x6e, 0x64, 0xf7, 0xaa, 0xe8,
	0x61, 0xf3, 0x99, 0x1e, 0xaa, 0x19, 0x52, 0x3a, 0xc4, 0xa8, 0x82, 0xd9, 0xe4, 0xe4, 0x78, 0xe2,
	...
	0x7a, 0xc9, 0xf9, 0xb9, 0xfa, 0x08, 0x13, 0xf5, 0xc1, 0x61, 0x5d, 0x01, 0xa1, 0x4a, 0x2a, 0x0b,
	0x52, 0x8b, 0x93, 0xd8, 0xc0, 0xc1, 0x6e, 0x0c, 0x08, 0x00, 0x00, 0xff, 0xff, 0x6a, 0x7d, 0xe8,
	0xb1, 0x87, 0x01, 0x00, 0x00,
}
...
func (c *msgClient) RequestLoan(ctx context.Context, in *MsgRequestLoan, opts ...grpc.CallOption) (*MsgRequestLoanResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/lukeajtodd.loan.loan.Msg/RequestLoan", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_RequestLoan_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/lukeajtodd.loan.loan.Msg/RequestLoan",
	}
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "lukeajtodd.loan.loan.Msg",
